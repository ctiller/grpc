...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/lib/config/config_from_environment.cc )
  s.files += %w( src/core/lib/config/config_from_environment.h )
  s.files += %w( src/core/lib/config/config_source.h )
  s.files += %w( src/core/lib/config/config_var_metadata.h )
