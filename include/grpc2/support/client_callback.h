...
#ifndef GRPC2_SUPPORT_CLIENT_CALLBACK_H
#define GRPC2_SUPPORT_CLIENT_CALLBACK_H
...
#include <grpc2/support/channel_interface.h>
...
void CallbackUnaryCall(grpc2::ChannelInterface* channel,
