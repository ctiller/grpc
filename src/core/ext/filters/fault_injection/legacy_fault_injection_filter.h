...
#ifndef GRPC_SRC_CORE_EXT_FILTERS_FAULT_INJECTION_LEGACY_FAULT_INJECTION_FILTER_H
#define GRPC_SRC_CORE_EXT_FILTERS_FAULT_INJECTION_LEGACY_FAULT_INJECTION_FILTER_H
...
class LegacyFaultInjectionFilter : public ChannelFilter {
 public:
  static const grpc_channel_filter kFilter;

  static absl::StatusOr<LegacyFaultInjectionFilter> Create(
 ...
 private:
  explicit LegacyFaultInjectionFilter(ChannelFilter::Args filter_args);
