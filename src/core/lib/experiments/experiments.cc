...
const char* const additional_constraints_unconstrained_max_quota_buffer_size =
    "{}";
const char* const description_v3_fault =
    "If set, use fault injection filter based on the v3 filter api.";
const char* const additional_constraints_v3_fault = "{}";
...
const ExperimentMetadata g_experiment_metadata[] = {
    ...
    {"unconstrained_max_quota_buffer_size",
     ...
     false, true},
    {"v3_fault", description_v3_fault, additional_constraints_v3_fault, nullptr,
     0, false, true},
