...
const uint8_t g_static_metadata_bytes[] = {
    ...
    111, 100, 105, 110, 103, 45,  114, 101, 113, 117, 101, 115, 116, 104, 111,
    115, 116, 103, 114, 112, 99,  45,  112, 114, 101, 118, 105, 111, 117, 115,
    45,  114, 112, 99,  45,  97,  116, 116, 101, 109, 112, 116, 115, 103, 114,
    112, 99,  45,  114, 101, 116, 114, 121, 45,  112, 117, 115, 104, 98,  97,
    99,  107, 45,  109, 115, 120, 45,  101, 110, 100, 112, 111, 105, 110, 116,
    45,  108, 111, 97,  100, 45,  109, 101, 116, 114, 105, 99,  115, 45,  98,
    105, 110, 103, 114, 112, 99,  45,  116, 105, 109, 101, 111, 117, 116, 49,
    50,  51,  52,  103, 114, 112, 99,  46,  119, 97,  105, 116, 95,  102, 111,
    114, 95,  114, 101, 97,  100, 121, 103, 114, 112, 99,  46,  116, 105, 109,
    101, 111, 117, 116, 103, 114, 112, 99,  46,  109, 97,  120, 95,  114, 101,
    113, 117, 101, 115, 116, 95,  109, 101, 115, 115, 97,  103, 101, 95,  98,
    121, 116, 101, 115, 103, 114, 112, 99,  46,  109, 97,  120, 95,  114, 101,
    115, 112, 111, 110, 115, 101, 95,  109, 101, 115, 115, 97,  103, 101, 95,
    98,  121, 116, 101, 115, 47,  103, 114, 112, 99,  46,  108, 98,  46,  118,
    49,  46,  76,  111, 97,  100, 66,  97,  108, 97,  110, 99,  101, 114, 47,
    66,  97,  108, 97,  110, 99,  101, 76,  111, 97,  100, 47,  101, 110, 118,
    111, 121, 46,  115, 101, 114, 118, 105, 99,  101, 46,  108, 111, 97,  100,
    95,  115, 116, 97,  116, 115, 46,  118, 50,  46,  76,  111, 97,  100, 82,
    ...
    46,  108, 111, 97,  100, 95,  115, 116, 97,  116, 115, 46,  118, 51,  46,
    76,  111, 97,  100, 82,  101, 112, 111, 114, 116, 105, 110, 103, 83,  101,
    114, 118, 105, 99,  101, 47,  83,  116, 114, 101, 97,  109, 76,  111, 97,
    100, 83,  116, 97,  116, 115, 47,  103, 114, 112, 99,  46,  104, 101, 97,
    ...
    82,  101, 115, 111, 117, 114, 99,  101, 115, 47,  101, 110, 118, 111, 121,
    46,  115, 101, 114, 118, 105, 99,  101, 46,  100, 105, 115, 99,  111, 118,
    101, 114, 121, 46,  118, 51,  46,  65,  103, 103, 114, 101, 103, 97,  116,
    ...
    105, 110, 103, 117, 115, 101, 114, 45,  97,  103, 101, 110, 116, 118, 97,
...
const StaticMetadataSlice
    g_static_metadata_slice_table[GRPC_STATIC_MDSTR_COUNT] = {
        ...
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[42].base, 3,
            g_static_metadata_bytes + 831),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[43].base, 4,
            g_static_metadata_bytes + 834),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[44].base, 1,
            g_static_metadata_bytes + 838),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[45].base, 11,
            g_static_metadata_bytes + 839),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[46].base, 4,
            g_static_metadata_bytes + 850),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[47].base, 5,
            g_static_metadata_bytes + 854),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[48].base, 3,
        ...
        grpc_core::StaticMetadataSlice(
            ...
            g_static_metadata_bytes + 871),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[53].base, 3,
            g_static_metadata_bytes + 874),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[54].base, 3,
            g_static_metadata_bytes + 877),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[55].base, 14,
            g_static_metadata_bytes + 880),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[56].base, 13,
            g_static_metadata_bytes + 894),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[57].base, 15,
            g_static_metadata_bytes + 907),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[58].base, 13,
            g_static_metadata_bytes + 922),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[59].base, 6,
            g_static_metadata_bytes + 935),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[60].base, 27,
            g_static_metadata_bytes + 941),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[61].base, 3,
            g_static_metadata_bytes + 968),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[62].base, 5,
            g_static_metadata_bytes + 971),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[63].base, 13,
            g_static_metadata_bytes + 976),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[64].base, 13,
            g_static_metadata_bytes + 989),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[65].base, 19,
            g_static_metadata_bytes + 1002),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[66].base, 16,
            g_static_metadata_bytes + 1021),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[67].base, 14,
            g_static_metadata_bytes + 1037),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[68].base, 16,
            g_static_metadata_bytes + 1051),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[69].base, 13,
            g_static_metadata_bytes + 1067),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[70].base, 6,
            g_static_metadata_bytes + 1080),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[71].base, 4,
            g_static_metadata_bytes + 1086),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[72].base, 4,
            g_static_metadata_bytes + 1090),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[73].base, 6,
            g_static_metadata_bytes + 1094),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[74].base, 7,
            g_static_metadata_bytes + 1100),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[75].base, 4,
            g_static_metadata_bytes + 1107),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[76].base, 8,
            g_static_metadata_bytes + 1111),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[77].base, 17,
            g_static_metadata_bytes + 1119),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[78].base, 13,
            g_static_metadata_bytes + 1136),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[79].base, 8,
            g_static_metadata_bytes + 1149),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[80].base, 19,
            g_static_metadata_bytes + 1157),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[81].base, 13,
            g_static_metadata_bytes + 1176),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[82].base, 4,
            g_static_metadata_bytes + 1189),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[83].base, 8,
            g_static_metadata_bytes + 1193),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[84].base, 12,
            g_static_metadata_bytes + 1201),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[85].base, 18,
            g_static_metadata_bytes + 1213),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[86].base, 19,
            g_static_metadata_bytes + 1231),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[87].base, 5,
            g_static_metadata_bytes + 1250),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[88].base, 7,
            g_static_metadata_bytes + 1255),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[89].base, 7,
            g_static_metadata_bytes + 1262),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[90].base, 11,
            g_static_metadata_bytes + 1269),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[91].base, 6,
            g_static_metadata_bytes + 1280),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[92].base, 10,
            g_static_metadata_bytes + 1286),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[93].base, 25,
            g_static_metadata_bytes + 1296),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[94].base, 17,
            g_static_metadata_bytes + 1321),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[95].base, 10,
            g_static_metadata_bytes + 1338),
        grpc_core::StaticMetadataSlice(
