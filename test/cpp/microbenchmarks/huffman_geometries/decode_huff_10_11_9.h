...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetOp47(size_t i) { return i; }
  static inline const uint8_t* GetEmit47(size_t, size_t emit) {
    return &table47_0_emit_[emit];
  }
  static inline uint64_t GetOp46(size_t i) {
 ...
 private:
  ...
  static const uint16_t table8_24_ops_[64];
  static const uint8_t table8_26_emit_[1];
  static const uint8_t table8_28_emit_[1];
  static const uint16_t table8_28_ops_[64];
  static const uint8_t table8_29_emit_[1];
  static const uint8_t table8_30_emit_[1];
  static const uint8_t table8_31_emit_[24];
  static const uint16_t table8_31_ops_[64];
  ...
  static const uint8_t table47_0_emit_[1];
  static const uint8_t table46_0_emit_[3];
};
template <typename C>
class HuffDecoder : public HuffDecoderCommon {
 ...
 private:
  ...
  void DecodeStep25() {
    ...
    buffer_len_ -= consumed;
    const auto emit_ofs = op >> 2;
    container_.push_back(*GetEmit46(index, emit_ofs));
  }
  void Done26() {
    done_ = true;
    switch (buffer_len_) {
      case 1: {
        ...
        switch (op & 1) {
          case 0: {
            container_.push_back(*GetEmit47(index, (op >> 1)));
            break;
          }
          case 1: {
            ok_ = false;
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_10_11_9_H
