...
class HuffDecoderCommon {
 protected:
  ...
  static inline const uint8_t* GetEmit40(size_t i, size_t emit) {
    return &table40_emit_[i >> 5][emit];
  }
  static inline uint64_t GetOp45(size_t i) { return i; }
 ...
 private:
  ...
  static const uint16_t table8_0_ops_[128];
  ...
  static const uint16_t table8_24_ops_[128];
  static const uint8_t table8_26_emit_[1];
  static const uint8_t table8_28_emit_[1];
  static const uint16_t table8_28_ops_[128];
  static const uint8_t table8_29_emit_[1];
  static const uint8_t table8_30_emit_[1];
  static const uint8_t table8_31_emit_[50];
  static const uint16_t table8_31_ops_[128];
  ...
  static const uint8_t table45_0_emit_[1];
  static const uint8_t table44_0_emit_[3];
};
template <typename C>
  ...
  void Done23() {
    ...
    switch (buffer_len_) {
      case 1: {
        ...
        switch (op & 1) {
          case 0: {
            container_.push_back(*GetEmit45(index, (op >> 1)));
            break;
          }
          case 1: {
            ok_ = false;
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_10_12_8_H
