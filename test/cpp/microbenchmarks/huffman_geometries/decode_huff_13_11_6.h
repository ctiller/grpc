...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_11_6_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_11_6_H
...
class HuffDecoderCommon {
 ...
 private:
  ...
  static const uint8_t table11_4_emit_[1];
  static const uint16_t table11_6_ops_[256];
  static const uint8_t table11_7_emit_[76];
  static const uint16_t table11_7_ops_[256];
  static const uint8_t* const table11_emit_[8];
  static const uint16_t* const table11_ops_[8];
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_11_6_H
