...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_5_12_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_5_12_H
...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetOp11(size_t i) {
    return table11_0_inner_[(i < 23 ? (i / 8 + 0) : ((i - 23) + 2))];
  }
  ...
  void Done10() {
    ...
    switch (buffer_len_) {
      ...
      case 10: {
        ...
        switch (op & 3) {
          case 0: {
            const uint8_t* p = GetEmit32(index, (op >> 2));
            container_.push_back(p[0]);
            container_.push_back(p[1]);
            break;
          }
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_5_12_H
