...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_7_10_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_7_10_H
...
class HuffDecoderCommon {
 protected:
  ...
  static inline const uint8_t* GetEmit9(size_t i, size_t emit) {
  ...
  static inline uint64_t GetOp11(size_t i) {
    return table11_ops_[i >> 5][i & 0x1f];
  }
  static inline const uint8_t* GetEmit11(size_t i, size_t emit) {
    return &table11_emit_[i >> 5][emit];
  }
 ...
 private:
  ...
  static const uint16_t table11_0_ops_[32];
  static const uint8_t table11_1_emit_[1];
  static const uint8_t table11_2_emit_[1];
  static const uint8_t table11_3_emit_[11];
  static const uint16_t table11_3_ops_[32];
    ...
    switch (buffer_len_) {
      ...
      case 12: {
        ...
        switch (op & 3) {
          ...
          case 1: {
            const uint8_t* p = GetEmit9(index, (op >> 2));
            container_.push_back(p[0]);
            container_.push_back(p[1]);
            break;
          }
  ...
  void Done2() {
    ...
    switch (buffer_len_) {
      ...
      case 2: {
        ...
        switch (op & 1) {
          case 0: {
            container_.push_back(*GetEmit12(index, (op >> 1)));
            break;
          }
        }
        return;
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_7_10_H
