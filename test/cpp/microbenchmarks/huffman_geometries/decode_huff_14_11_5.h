...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_14_11_5_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_14_11_5_H
...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetOp35(size_t i) { return table34_0_inner_[i]; }
  ...
  static inline uint64_t GetOp38(size_t i) {
    return table38_0_inner_[(i < 1 ? (((void)i, 0)) : ((i - 1)))];
  }
  static inline const uint8_t* GetEmit38(size_t, size_t emit) {
    return &table38_0_emit_[emit];
  }
  static inline uint64_t GetOp41(size_t i) { return table41_0_inner_[i]; }
  ...
  static inline uint64_t GetOp42(size_t i) {
    return table42_0_inner_[table42_0_outer_[i]];
  }
 ...
 private:
  ...
  static const uint16_t table12_16_ops_[64];
  static const uint8_t table12_17_emit_[1];
  static const uint8_t table12_18_emit_[1];
  static const uint16_t table12_19_ops_[64];
  static const uint16_t table12_23_ops_[64];
  static const uint16_t table12_26_ops_[64];
  static const uint16_t table12_27_ops_[64];
  static const uint16_t table12_29_ops_[64];
  static const uint16_t table12_30_ops_[64];
  static const uint8_t table12_31_emit_[21];
  static const uint16_t table12_31_ops_[64];
  ...
  static const uint8_t table36_0_emit_[3];
  static const uint8_t table39_0_emit_[1];
  static const uint8_t table38_0_emit_[7];
  static const uint8_t table38_0_inner_[7];
  static const uint8_t table41_0_emit_[7];
  static const uint8_t table41_0_inner_[8];
  static const uint8_t table42_0_inner_[9];
  static const uint8_t table42_0_outer_[16];
...
class HuffDecoder : public HuffDecoderCommon {
 ...
 private:
    ...
    switch (buffer_len_) {
      ...
      case 13: {
        ...
        switch (op & 3) {
          ...
          case 1: {
            const uint8_t* p = GetEmit10(index, (op >> 2));
            container_.push_back(p[0]);
            container_.push_back(p[1]);
            break;
          }
  ...
  void Done16() {
    ...
    switch (buffer_len_) {
      case 1: {
        ...
        switch (op & 1) {
          case 0: {
            container_.push_back(*GetEmit37(index, (op >> 1)));
            break;
          }
          case 1: {
            ok_ = false;
  ...
  void Done17() {
    ...
    switch (buffer_len_) {
      ...
      case 2: {
        ...
        switch (op & 1) {
          case 0: {
            container_.push_back(*GetEmit39(index, (op >> 1)));
            break;
          }
          case 1: {
            ok_ = false;
  ...
  void DecodeStep17() {
    ...
    switch ((op >> 3) & 1) {
      case 0: {
        container_.push_back(*GetEmit40(index, emit_ofs));
        break;
      }
      case 1: {
        begin_ = end_;
  ...
  void Done18() {
    ...
    switch (buffer_len_) {
      ...
      case 3: {
        ...
        switch (op & 1) {
          case 0: {
            container_.push_back(*GetEmit41(index, (op >> 1)));
            break;
          }
        }
        return;
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_14_11_5_H
