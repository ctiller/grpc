...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_14_9_7_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_14_9_7_H
#include <grpc/support/port_platform.h>

#include <cstddef>
#include <cstdint>
namespace grpc_core {
namespace geometry_14_9_7 {
class HuffDecoderCommon {
 ...
 private:
  ...
  static const uint16_t table12_2_ops_[128];
  static const uint8_t table12_3_emit_[64];
  static const uint16_t table12_3_ops_[128];
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_14_9_7_H
