...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_15_8_7_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_15_8_7_H
...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetOp26(size_t i) {
    return table26_ops_[i >> 5][i & 0x1f];
  }
  static inline const uint8_t* GetEmit26(size_t i, size_t emit) {
    return &table26_emit_[i >> 5][emit];
  }
  ...
  static inline uint64_t GetOp30(size_t i) {
    return table30_0_inner_[(i < 13 ? (i / 2 + 0) : ((i - 13) + 6))];
  }
 ...
 private:
  ...
  static const uint8_t table28_0_emit_[30];
  ...
  static const uint8_t table26_1_emit_[8];
  static const uint8_t table26_1_ops_[32];
  static const uint8_t table26_2_emit_[8];
  static const uint8_t table26_3_emit_[10];
  static const uint8_t table26_3_ops_[32];
  static const uint8_t* const table26_emit_[4];
  static const uint8_t* const table26_ops_[4];
  static const uint8_t table31_0_emit_[7];
  static const uint8_t table31_0_inner_[8];
  static const uint8_t table30_0_emit_[9];
  static const uint8_t table30_0_inner_[9];
};
template <typename C>
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_15_8_7_H
