...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_15_9_6_H
...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetOp27(size_t i) {
    return table27_0_inner_[(i < 5 ? (i / 2 + 0) : ((i - 5) + 2))];
  }
 ...
 private:
  ...
  static const uint8_t table12_3_emit_[2];
  static const uint16_t table12_3_ops_[32];
  static const uint8_t table12_4_emit_[2];
  static const uint8_t table12_5_emit_[2];
  static const uint8_t table12_6_emit_[2];
  static const uint8_t table12_7_emit_[4];
  static const uint16_t table12_7_ops_[32];
  static const uint8_t table12_8_emit_[4];
  static const uint8_t table12_9_emit_[4];
  static const uint8_t table12_10_emit_[7];
  static const uint16_t table12_10_ops_[32];
  static const uint8_t table12_11_emit_[8];
  static const uint16_t table12_11_ops_[32];
  static const uint8_t table12_12_emit_[8];
  static const uint8_t table12_13_emit_[12];
  static const uint16_t table12_13_ops_[32];
  static const uint8_t table12_14_emit_[16];
  static const uint16_t table12_14_ops_[32];
  static const uint8_t table12_15_emit_[17];
  static const uint16_t table12_15_ops_[32];
  ...
  static const uint8_t table27_0_emit_[5];
  static const uint8_t table27_0_inner_[5];
  ...
  static const uint8_t table29_1_emit_[10];
  static const uint8_t table29_1_ops_[32];
  static const uint8_t* const table29_emit_[2];
  static const uint8_t* const table29_ops_[2];
};
template <typename C>
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_15_9_6_H
