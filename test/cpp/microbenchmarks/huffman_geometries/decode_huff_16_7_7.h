...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_16_7_7_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_16_7_7_H
#include <grpc/support/port_platform.h>

#include <cstddef>
#include <cstdint>
namespace grpc_core {
namespace geometry_16_7_7 {
class HuffDecoderCommon {
 ...
 private:
  ...
  static const uint8_t table16_0_emit_[64];
  static const uint16_t table16_0_inner_[75];
  static const uint8_t table16_0_outer_[128];
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_16_7_7_H
