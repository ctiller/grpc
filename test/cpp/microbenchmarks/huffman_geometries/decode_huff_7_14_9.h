...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_7_14_9_H
...
class HuffDecoderCommon {
 ...
 private:
  ...
  static const uint8_t table7_40_emit_[1];
  static const uint16_t table7_40_ops_[256];
  static const uint8_t table7_44_emit_[1];
  static const uint8_t table7_48_emit_[1];
  static const uint8_t table7_52_emit_[1];
  static const uint16_t table7_52_ops_[256];
  static const uint8_t table7_54_emit_[1];
  static const uint8_t table7_56_emit_[1];
  static const uint16_t table7_56_ops_[256];
  static const uint8_t table7_57_emit_[1];
  static const uint8_t table7_58_emit_[1];
  static const uint8_t table7_59_emit_[1];
  static const uint8_t table7_60_emit_[1];
  static const uint8_t table7_61_emit_[1];
  static const uint8_t table7_62_emit_[2];
  static const uint16_t table7_62_ops_[256];
  static const uint8_t table7_63_emit_[27];
  static const uint16_t table7_63_ops_[256];
  static const uint8_t* const table7_emit_[64];
  static const uint16_t* const table7_ops_[64];
  ...
  static const uint8_t table31_0_emit_[2];
  ...
  static const uint8_t table37_0_emit_[4];
  ...
  static const uint8_t table42_0_emit_[1];
...
class HuffDecoder : public HuffDecoderCommon {
 ...
 private:
  ...
  void Done4() {
    ...
    switch (buffer_len_) {
      ...
      case 13: {
        ...
        switch (op & 7) {
          case 0: {
            const uint8_t* p = GetEmit18(index, (op >> 3));
            container_.push_back(p[0]);
            container_.push_back(p[1]);
          ...
          case 3: {
            container_.push_back(*GetEmit18(index, (op >> 3)));
            break;
          }
        }
        return;
  ...
  void DecodeStep23() {
    ...
    buffer_len_ -= consumed;
    const auto emit_ofs = op >> 2;
    container_.push_back(*GetEmit38(index, emit_ofs));
  }
  void Done24() {
    done_ = true;
    switch (buffer_len_) {
  ...
  void DecodeStep25() {
    ...
    buffer_len_ -= consumed;
    const auto emit_ofs = op >> 2;
    container_.push_back(*GetEmit41(index, emit_ofs));
  }
  bool RefillTo3() {
    switch (buffer_len_) {
      case 0: {
  ...
  void Done26() {
    ...
    switch (buffer_len_) {
      ...
      case 2: {
        ...
        switch (op & 1) {
          case 0: {
            container_.push_back(*GetEmit42(index, (op >> 1)));
            break;
          }
          case 1: {
            ok_ = false;
  ...
  void DecodeStep26() {
    ...
    switch ((op >> 4) & 1) {
      case 0: {
        container_.push_back(*GetEmit43(index, emit_ofs));
        break;
      }
      case 1: {
        begin_ = end_;
    ...
    switch (buffer_len_) {
      ...
      case 7: {
        ...
        switch (op & 3) {
          ...
          case 1: {
            container_.push_back(*GetEmit46(index, (op >> 2)));
            break;
          }
        }
        return;
      ...
      case 8: {
        ...
        switch (op & 3) {
          ...
          case 1: {
            container_.push_back(*GetEmit47(index, (op >> 2)));
            break;
          }
        }
        return;
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_7_14_9_H
