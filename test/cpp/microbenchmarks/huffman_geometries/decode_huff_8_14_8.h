...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_8_14_8_H
...
class HuffDecoderCommon {
 ...
 private:
  ...
  static const uint16_t table6_60_ops_[256];
  static const uint8_t table6_61_emit_[1];
  static const uint8_t table6_62_emit_[2];
  static const uint16_t table6_62_ops_[256];
  static const uint8_t table6_63_emit_[51];
  static const uint16_t table6_63_ops_[256];
  ...
  static const uint8_t table40_0_emit_[2];
  ...
  void Done2() {
    ...
    switch (buffer_len_) {
      ...
      case 12: {
        ...
        switch (op & 7) {
          case 0: {
            const uint8_t* p = GetEmit17(index, (op >> 3));
            container_.push_back(p[0]);
            container_.push_back(p[1]);
          ...
          case 3: {
            container_.push_back(*GetEmit17(index, (op >> 3)));
            break;
          }
        }
        return;
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_8_14_8_H
