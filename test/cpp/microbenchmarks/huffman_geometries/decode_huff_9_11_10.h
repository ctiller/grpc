...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_9_11_10_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_9_11_10_H
...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetOp34(size_t i) { return table32_0_inner_[i]; }
  static inline const uint8_t* GetEmit34(size_t, size_t emit) {
    return &table34_0_emit_[emit];
  }
  static inline uint64_t GetOp36(size_t i) { return i; }
  ...
  static inline uint64_t GetOp38(size_t i) {
    return table38_0_inner_[(i < 5 ? (i) : (((void)(i - 5), 5)))];
  }
  ...
  static inline uint64_t GetOp37(size_t i) {
    return table37_0_inner_[(i < 9 ? (i / 2 + 0) : ((i - 9) + 4))];
  }
  ...
  static inline uint64_t GetOp40(size_t i) {
    return table40_0_inner_[(i < 6 ? (i) : ((i - 6) / 9 + 6))];
  }
  ...
  static inline uint64_t GetOp44(size_t i) {
    return table44_ops_[i >> 7][i & 0x7f];
  }
  static inline const uint8_t* GetEmit44(size_t i, size_t emit) {
    return &table44_emit_[i >> 7][emit];
  }
  static inline uint64_t GetOp45(size_t i) {
    return table45_ops_[i >> 6][i & 0x3f];
  }
  static inline const uint8_t* GetEmit45(size_t i, size_t emit) {
    return &table45_emit_[i >> 6][emit];
  }
  static inline uint64_t GetOp39(size_t i) {
    return table39_ops_[i >> 6][i & 0x3f];
  }
  static inline const uint8_t* GetEmit39(size_t i, size_t emit) {
 ...
 private:
  ...
  static const uint16_t table10_4_ops_[128];
  ...
  static const uint16_t table10_14_ops_[128];
  static const uint8_t table10_15_emit_[14];
  static const uint16_t table10_15_ops_[128];
  ...
  static const uint8_t table29_0_emit_[4];
  ...
  static const uint8_t table35_0_emit_[3];
  static const uint8_t table38_0_emit_[5];
  static const uint8_t table38_0_inner_[6];
  static const uint8_t table37_0_emit_[11];
  static const uint8_t table37_0_inner_[11];
  static const uint8_t table40_0_emit_[6];
  static const uint8_t table40_0_inner_[8];
  static const uint8_t table41_0_emit_[10];
  static const uint8_t table41_0_ops_[32];
  static const uint8_t table42_0_emit_[25];
  static const uint8_t table42_0_ops_[64];
  static const uint8_t table43_0_emit_[44];
  static const uint8_t table43_0_ops_[128];
  static const uint8_t table44_0_ops_[128];
  static const uint8_t table44_1_emit_[63];
  static const uint8_t table44_1_ops_[128];
  static const uint8_t* const table44_emit_[2];
  static const uint8_t* const table44_ops_[2];
  static const uint8_t table45_0_emit_[40];
  static const uint8_t table45_0_ops_[64];
  static const uint8_t table45_1_emit_[40];
  static const uint8_t table45_2_emit_[40];
  static const uint8_t table45_3_emit_[4];
  static const uint8_t table45_3_ops_[64];
  static const uint8_t table45_4_emit_[8];
  static const uint8_t table45_4_ops_[64];
  static const uint8_t table45_5_emit_[9];
  static const uint8_t table45_5_ops_[64];
  static const uint8_t table45_6_emit_[16];
  static const uint8_t table45_6_ops_[64];
  static const uint8_t table45_7_emit_[30];
  static const uint8_t table45_7_ops_[64];
  static const uint8_t* const table45_emit_[8];
  static const uint8_t* const table45_ops_[8];
  static const uint8_t table39_0_emit_[1];
  static const uint16_t table39_0_ops_[64];
  static const uint8_t table39_1_emit_[1];
  static const uint8_t table39_2_emit_[1];
  static const uint8_t table39_3_emit_[1];
  static const uint8_t table39_4_emit_[1];
  static const uint8_t table39_5_emit_[1];
  static const uint8_t table39_6_emit_[2];
  static const uint16_t table39_6_ops_[64];
  static const uint8_t table39_7_emit_[2];
  static const uint8_t table39_8_emit_[4];
  static const uint16_t table39_8_ops_[64];
  static const uint8_t table39_9_emit_[4];
  static const uint8_t table39_10_emit_[4];
  static const uint8_t table39_11_emit_[5];
  static const uint16_t table39_11_ops_[64];
  static const uint8_t table39_12_emit_[8];
  static const uint16_t table39_12_ops_[64];
  static const uint8_t table39_13_emit_[8];
  static const uint8_t table39_14_emit_[15];
  static const uint16_t table39_14_ops_[64];
  static const uint8_t table39_15_emit_[18];
  static const uint16_t table39_15_ops_[64];
  ...
  void Done20() {
    ...
    switch (buffer_len_) {
      case 1: {
        ...
        switch (op & 1) {
          case 0: {
            container_.push_back(*GetEmit36(index, (op >> 1)));
            break;
          }
          case 1: {
            ok_ = false;
    ...
    switch (buffer_len_) {
      ...
      case 7: {
        ...
        switch (op & 3) {
          ...
          case 1: {
            container_.push_back(*GetEmit43(index, (op >> 2)));
            break;
          }
        }
        return;
      ...
      case 8: {
        ...
        switch (op & 3) {
          ...
          case 1: {
            container_.push_back(*GetEmit44(index, (op >> 2)));
            break;
          }
        }
        return;
      ...
      case 9: {
        ...
        switch (op & 3) {
          case 0: {
            const uint8_t* p = GetEmit45(index, (op >> 2));
            container_.push_back(p[0]);
            container_.push_back(p[1]);
            break;
          }
          ...
          case 2: {
            container_.push_back(*GetEmit45(index, (op >> 2)));
            break;
          }
        }
        return;
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_9_11_10_H
