...
const uint8_t HuffDecoderCommon::table21_0_emit_[2] = {0x81, 0x84};
const uint8_t HuffDecoderCommon::table22_0_emit_[2] = {0x85, 0x86};
const uint8_t HuffDecoderCommon::table23_0_emit_[2] = {0x88, 0x92};
const uint8_t HuffDecoderCommon::table24_0_emit_[2] = {0x9a, 0x9c};
const uint8_t HuffDecoderCommon::table25_0_emit_[2] = {0xa0, 0xa3};
const uint8_t HuffDecoderCommon::table26_0_emit_[2] = {0xa4, 0xa9};
const uint8_t HuffDecoderCommon::table27_0_emit_[2] = {0xaa, 0xad};
const uint8_t HuffDecoderCommon::table28_0_emit_[2] = {0xb2, 0xb5};
const uint8_t HuffDecoderCommon::table29_0_emit_[2] = {0xb9, 0xba};
const uint8_t HuffDecoderCommon::table30_0_emit_[2] = {0xbb, 0xbd};
const uint8_t HuffDecoderCommon::table31_0_emit_[2] = {0xbe, 0xc4};
const uint8_t HuffDecoderCommon::table32_0_emit_[2] = {0xc6, 0xe4};
const uint8_t HuffDecoderCommon::table33_0_emit_[2] = {0xe8, 0xe9};
const uint8_t HuffDecoderCommon::table34_0_emit_[4] = {0x01, 0x87, 0x89, 0x8a};
const uint8_t HuffDecoderCommon::table35_0_emit_[4] = {0x8b, 0x8c, 0x8d, 0x8f};
const uint8_t HuffDecoderCommon::table36_0_emit_[4] = {0x93, 0x95, 0x96, 0x97};
const uint8_t HuffDecoderCommon::table37_0_emit_[4] = {0x98, 0x9b, 0x9d, 0x9e};
const uint8_t HuffDecoderCommon::table38_0_emit_[4] = {0xa5, 0xa6, 0xa8, 0xae};
const uint8_t HuffDecoderCommon::table39_0_emit_[4] = {0xaf, 0xb4, 0xb6, 0xb7};
const uint8_t HuffDecoderCommon::table40_0_emit_[4] = {0xbc, 0xbf, 0xc5, 0xe7};
...
const uint8_t HuffDecoderCommon::table44_0_emit_[1] = {0xef};
