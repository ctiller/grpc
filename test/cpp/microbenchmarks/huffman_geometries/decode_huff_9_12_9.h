...
class HuffDecoderCommon {
 protected:
  ...
  static inline const uint8_t* GetEmit48(size_t, size_t emit) {
    return &table48_0_emit_[emit];
  }
  static inline uint64_t GetOp49(size_t i) { return table49_0_ops_[i]; }
  static inline const uint8_t* GetEmit49(size_t, size_t emit) {
    return &table48_0_emit_[emit];
  }
 ...
 private:
  ...
  static const uint8_t table39_0_emit_[4];
  ...
  static const uint8_t table44_0_emit_[1];
...
class HuffDecoder : public HuffDecoderCommon {
 ...
 private:
  ...
  void Done26() {
    ...
    switch (buffer_len_) {
      ...
      case 2: {
        ...
        switch (op & 1) {
          case 0: {
            container_.push_back(*GetEmit44(index, (op >> 1)));
            break;
          }
          case 1: {
            ok_ = false;
  ...
  void DecodeStep26() {
    ...
    switch ((op >> 4) & 1) {
      case 0: {
        container_.push_back(*GetEmit45(index, emit_ofs));
        break;
      }
      case 1: {
        begin_ = end_;
    ...
    switch (buffer_len_) {
      ...
      case 7: {
        ...
        switch (op & 3) {
          ...
          case 1: {
            container_.push_back(*GetEmit48(index, (op >> 2)));
            break;
          }
        }
        return;
      ...
      case 8: {
        ...
        switch (op & 3) {
          ...
          case 1: {
            container_.push_back(*GetEmit49(index, (op >> 2)));
            break;
          }
        }
        return;
