...
const uint16_t HuffDecoderCommon::table10_56_ops_[512] = {
...
const uint8_t HuffDecoderCommon::table10_63_emit_[91] = {
    0x5c, 0xc3, 0xd0, 0x80, 0x82, 0x83, 0xa2, 0xb8, 0xc2, 0xe0, 0xe2, 0x99,
    0xa1, 0xa7, 0xac, 0xb0, 0xb1, 0xb3, 0xd1, 0xd8, 0xd9, 0xe3, 0xe5, 0xe6,
...
const uint16_t HuffDecoderCommon::table10_63_ops_[512] = {
    ...
    0x020a, 0x020a, 0x020a, 0x020a, 0x020a, 0x020a, 0x020a, 0x020a, 0x020a,
    0x020a, 0x020a, 0x020a, 0x020a, 0x020a, 0x020a, 0x030b, 0x030b, 0x030b,
    0x030b, 0x030b, 0x030b, 0x030b, 0x030b, 0x030b, 0x030b, 0x030b, 0x030b,
    0x030b, 0x030b, 0x030b, 0x030b, 0x040b, 0x040b, 0x040b, 0x040b, 0x040b,
    0x040b, 0x040b, 0x040b, 0x040b, 0x040b, 0x040b, 0x040b, 0x040b, 0x040b,
    0x040b, 0x040b, 0x050b, 0x050b, 0x050b, 0x050b, 0x050b, 0x050b, 0x050b,
    ...
    0x060b, 0x060b, 0x060b, 0x060b, 0x060b, 0x060b, 0x060b, 0x070b, 0x070b,
    ...
    0x080b, 0x080b, 0x080b, 0x090b, 0x090b, 0x090b, 0x090b, 0x090b, 0x090b,
    0x090b, 0x090b, 0x090b, 0x090b, 0x090b, 0x090b, 0x090b, 0x090b, 0x090b,
    0x090b, 0x0a0b, 0x0a0b, 0x0a0b, 0x0a0b, 0x0a0b, 0x0a0b, 0x0a0b, 0x0a0b,
    0x0a0b, 0x0a0b, 0x0a0b, 0x0a0b, 0x0a0b, 0x0a0b, 0x0a0b, 0x0a0b, 0x0b0c,
    0x0b0c, 0x0b0c, 0x0b0c, 0x0b0c, 0x0b0c, 0x0b0c, 0x0b0c, 0x0c0c, 0x0c0c,
    0x0c0c, 0x0c0c, 0x0c0c, 0x0c0c, 0x0c0c, 0x0c0c, 0x0d0c, 0x0d0c, 0x0d0c,
    0x0d0c, 0x0d0c, 0x0d0c, 0x0d0c, 0x0d0c, 0x0e0c, 0x0e0c, 0x0e0c, 0x0e0c,
    0x0e0c, 0x0e0c, 0x0e0c, 0x0e0c, 0x0f0c, 0x0f0c, 0x0f0c, 0x0f0c, 0x0f0c,
    0x0f0c, 0x0f0c, 0x0f0c, 0x100c, 0x100c, 0x100c, 0x100c, 0x100c, 0x100c,
    0x100c, 0x100c, 0x110c, 0x110c, 0x110c, 0x110c, 0x110c, 0x110c, 0x110c,
    0x110c, 0x120c, 0x120c, 0x120c, 0x120c, 0x120c, 0x120c, 0x120c, 0x120c,
    0x130c, 0x130c, 0x130c, 0x130c, 0x130c, 0x130c, 0x130c, 0x130c, 0x140c,
    0x003f, 0x004f, 0x005f, 0x006f, 0x007f, 0x008f, 0x009f, 0x00af};
...
const uint8_t HuffDecoderCommon::table24_0_emit_[2] = {0xc7, 0xcf};
const uint8_t HuffDecoderCommon::table25_0_emit_[2] = {0xea, 0xeb};
const uint8_t HuffDecoderCommon::table26_0_emit_[4] = {0xc0, 0xc1, 0xc8, 0xc9};
const uint8_t HuffDecoderCommon::table27_0_emit_[4] = {0xca, 0xcd, 0xd2, 0xd5};
const uint8_t HuffDecoderCommon::table28_0_emit_[4] = {0xda, 0xdb, 0xee, 0xf0};
const uint8_t HuffDecoderCommon::table29_0_emit_[8] = {0xd3, 0xd4, 0xd6, 0xdd,
                                                       0xde, 0xdf, 0xf1, 0xf4};
const uint8_t HuffDecoderCommon::table29_0_inner_[8] = {0x03, 0x07, 0x0b, 0x0f,
                                                        0x13, 0x17, 0x1b, 0x1f};
const uint8_t HuffDecoderCommon::table30_0_emit_[8] = {0xf5, 0xf6, 0xf7, 0xf8,
                                                       0xfa, 0xfb, 0xfc, 0xfd};
const uint8_t HuffDecoderCommon::table32_0_emit_[1] = {0xfe};
const uint8_t HuffDecoderCommon::table31_0_emit_[15] = {
    0xfe, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
    0x0b, 0x0c, 0x0e, 0x0f, 0x10, 0x11, 0x12};
const uint8_t HuffDecoderCommon::table31_0_inner_[15] = {
    0x03, 0x0c, 0x14, 0x1c, 0x24, 0x2c, 0x34, 0x3c,
    0x44, 0x4c, 0x54, 0x5c, 0x64, 0x6c, 0x74};
const uint8_t HuffDecoderCommon::table34_0_emit_[3] = {0xf2, 0xf3, 0xff};
const uint8_t HuffDecoderCommon::table33_0_emit_[5] = {0xf2, 0xf3, 0xff, 0xcb,
                                                       0xcc};
const uint8_t HuffDecoderCommon::table33_0_inner_[5] = {0x02, 0x06, 0x0a, 0x0f,
                                                        0x13};
...
const uint8_t HuffDecoderCommon::table35_0_emit_[8] = {0x13, 0x14, 0x15, 0x17,
                                                       0x18, 0x19, 0x1a, 0x1b};
...
const uint8_t HuffDecoderCommon::table35_1_emit_[10] = {
    0x1c, 0x1d, 0x1e, 0x1f, 0x7f, 0xdc, 0xf9, 0x0a, 0x0d, 0x16};
const uint8_t HuffDecoderCommon::table35_1_ops_[32] = {
    0x04, 0x04, 0x04, 0x04, 0x14, 0x14, 0x14, 0x14, 0x24, 0x24, 0x24,
    0x24, 0x34, 0x34, 0x34, 0x34, 0x44, 0x44, 0x44, 0x44, 0x54, 0x54,
    0x54, 0x54, 0x64, 0x64, 0x64, 0x64, 0x76, 0x86, 0x96, 0x0e};
const uint8_t* const HuffDecoderCommon::table35_emit_[2] = {
    table35_0_emit_,
    table35_1_emit_,
};
const uint8_t* const HuffDecoderCommon::table35_ops_[2] = {
    table35_0_ops_,
    table35_1_ops_,
};
}  // namespace geometry_9_15_6
