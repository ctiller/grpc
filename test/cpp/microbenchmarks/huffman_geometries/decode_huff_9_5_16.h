  ...
  void Done6() {
    ...
    switch (buffer_len_) {
      case 1: {
        ...
        switch (op & 1) {
          case 0: {
            container_.push_back(*GetEmit16(index, (op >> 1)));
            break;
          }
        }
        return;
      ...
      case 14: {
        ...
        switch (op & 7) {
          ...
          case 1: {
            const uint8_t* p = GetEmit29(index, (op >> 3));
            container_.push_back(p[0]);
            container_.push_back(p[1]);
            container_.push_back(p[2]);
            break;
          ...
          case 3: {
            container_.push_back(*GetEmit29(index, (op >> 3)));
            break;
          }
        }
        return;
      ...
      case 15: {
        ...
        switch (op & 7) {
          ...
          case 1: {
            const uint8_t* p = GetEmit30(index, (op >> 3));
            container_.push_back(p[0]);
            container_.push_back(p[1]);
            container_.push_back(p[2]);
            break;
          ...
          case 3: {
            container_.push_back(*GetEmit30(index, (op >> 3)));
            break;
          }
        }
        return;
